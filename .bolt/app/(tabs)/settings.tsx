...
import { Bell, Shield, CreditCard, CircleHelp as HelpCircle, LogOut, Moon, Globe, ChevronRight } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <SettingItem
            icon={<Moon size={20} color="#ff3b3b" />}
            title="Mode sombre"
          ...
          <SettingItem
            icon={<Globe size={20} color="#ff3b3b" />}
            title="Langue"
            subtitle="Français"
            onPress={() => Alert.alert('Info', 'Sélection de la langue')}
          />
        </View>
