-- RLS Policies for Your Existing Database Structure - FIXED VERSION
...
-- SECTION 12: Insert sample data for testing (WITHOUT services table for now)
...
-- NOTE: Services table sample data will be added after we check the valid enum values
