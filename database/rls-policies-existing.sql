-- RLS Policies for Your Existing Database Structure
...
-- SECTION 12: Insert sample data for testing
...
INSERT INTO services (pro_id, titre, description, tarif, type, photo_url) VALUES
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Séance Portrait', 'Séance photo portrait professionnel', 150.00, 'portrait', 'https://example.com/portrait.jpg'),
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Séance Couple', 'Séance photo pour couples', 200.00, 'couple', 'https://example.com/couple.jpg'),
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Séance Famille', 'Séance photo familiale', 250.00, 'famille', 'https://example.com/famille.jpg')
ON CONFLICT DO NOTHING;
