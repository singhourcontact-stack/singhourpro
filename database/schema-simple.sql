-- SINGHOUR'S Pro Database Schema - Simplified Version
...
-- Step 3: Create working_hours table
...
-- Step 4: Create blocked_dates table
...
-- Step 7: Create google_calendar_settings table
...
-- Google calendar settings policies
...
-- Step 13: Create functions for updated_at timestamps
